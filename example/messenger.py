...
def received_message(event):
    ...
    if message_text:
        ...
        page.send(recipient, Attachment.Image(CONFIG['SERVER_URL'] + random.choice(hodor_images)))
        #-------------------------------------------------------------------------------------------------------------------
hodor_images = [
    "/assets/hodor_1.jpg",
    "/assets/hodor_2.jpg",
...
def send_message(recipient_id, text):
    ...
    if text in special_keywords:
        ...
        page.send(recipient_id, random.choice(hodor_replies), callback=send_text_callback, notification_type=NotificationType.REGULAR)
